<template>
  <Teleport to="body">
    <div class="fixed bottom-32 left-1/2 transform -translate-x-1/2 z-[99999] flex flex-col-reverse gap-3 max-w-sm w-full items-center px-4 pointer-events-none">
      <TransitionGroup name="toast">
        <div
          ...
          class="w-full rounded-2xl border p-[12px] flex items-center gap-3 cursor-pointer shadow-lg"
