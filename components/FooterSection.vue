<!-- <template>
    <footer class="bg-[#000000]" aria-labelledby="footer-heading">
            ...
            <div class="mt-16 grid grid-cols-2 gap-8 xl:col-span-2 xl:mt-0">
              <div class="md:grid md:grid-cols-2 md:gap-8">
                ...
                <div class="mt-10 md:mt-0">
                  <h3 data-aos="fade-up" class="text-sm font-semibold leading-6 text-white">Product</h3>
                  <ul role="list" class="mt-6 space-y-4">
                    <li>
                      <a href="#" class="text-sm leading-6 text-gray-300 hover:text-white">Home</a>
                    </li>
                    <li>
                      <a data-aos="fade-up" href="#" class="text-sm leading-6 text-gray-300 hover:text-white">Find Ambulances</a>
                    </li>
                    <li>
                      <a data-aos="fade-up" href="#" class="text-sm leading-6 text-gray-300 hover:text-white">First aid tips</a>
                    </li>
                    <li>
                      <a data-aos="fade-up" href="#" class="text-sm leading-6 text-gray-300 hover:text-white">About CODE-RED</a>
                    </li>
                    <li>
                        <a data-aos="fade-up" href="#" class="text-sm leading-6 text-gray-300 hover:text-white">Health articles</a>
                      </li>
                  </ul>
                </div>
              </div>
          ...
          <div class="mt-16 pt-8 sm:mt-20 lg:mt-24">
            <div class="text-xs leading-5 text-gray-400">
                <ul role="list" class="flex items-center gap-x-3 lg:gap-x-7">
                    ...
                    <li>
                      <a  href="#" class="text-sm leading-6 text-gray-300 hover:text-white">Terms of Use</a>
                    </li>
                    <li>
                      <a  href="#" class="text-sm leading-6 text-gray-300 hover:text-white">Legal</a>
                    </li>
                    <li>
...
<template>
  <div class="">
   <div class="grid grid-cols-1 lg:grid-cols-3">
     <div class="bg-[#1D1D1D] p-5 px-10 flex py-16 justify-center items-center">
       <div class="bg-[#1D1D1D] w-full lg:w-auto">
         <h2 class="text-2xl font-semibold text-[#EBEBEB] mb-4">FEEDBACK</h2>
 ...
 <path d="M22 6C22 4.9 21.1 4 20 4H4C2.9 4 2 4.9 2 6M22 6V18C22 19.1 21.1 20 20 20H4C2.9 20 2 19.1 2 18V6M22 6L12 13L2 6" stroke="#0072C6" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
             ...
             <div>
               ...
               <a href="mailto:emergencycoderedapp@gmail.com" class="text-[#00BFFF] text-sm hover:underline">emergencycoderedapp@gmail.com</a>
             </div>
           </div>
 ...
 <path d="M22.0004 18.9201V21.9201C22.0016 22.1986 21.9445 22.4743 21.8329 22.7294C21.7214 22.9846 21.5577 23.2137 21.3525 23.402C21.1473 23.5902 20.905 23.7336 20.6412 23.8228C20.3773 23.912 20.0978 23.9452 19.8204 23.9201C16.7433 23.5857 13.7874 22.5342 11.1904 20.8501C8.77425 19.3148 6.72576 17.2663 5.19042 14.8501C3.5004 12.2413 2.44866 9.27109 2.12042 6.1801C2.09543 5.90356 2.1283 5.62486 2.21692 5.36172C2.30555 5.09859 2.44799 4.85679 2.63519 4.65172C2.82238 4.44665 3.05023 4.28281 3.30421 4.17062C3.5582 4.05843 3.83276 4.00036 4.11042 4.0001H7.11042C7.59573 3.99532 8.06621 4.16718 8.43418 4.48363C8.80215 4.80008 9.0425 5.23954 9.11042 5.7201C9.23704 6.68016 9.47187 7.62282 9.81042 8.5301C9.94497 8.88802 9.97408 9.27701 9.89433 9.65098C9.81457 10.0249 9.62928 10.3682 9.36042 10.6401L8.09042 11.9101C9.51398 14.4136 11.5869 16.4865 14.0904 17.9101L15.3604 16.6401C15.6323 16.3712 15.9756 16.1859 16.3495 16.1062C16.7235 16.0264 17.1125 16.0556 17.4704 16.1901C18.3777 16.5286 19.3204 16.7635 20.2804 16.8901C20.7662 16.9586 21.2098 17.2033 21.527 17.5776C21.8441 17.9519 22.0126 18.4297 22.0004 18.9201Z" stroke="#0072C6" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
             ...
             <div>
               ...
               <a href="tel:+2348128646227" class="text-[#00BFFF] text-sm">+234 812 864 6227</a>
       ...
       <form @submit.prevent="sendMessage" class="space-y-6 w-full px-8 lg:max-w-lg mx-auto">
           ...
           <div class="flex items-center">
             ...
             <label class="ml-2 text-sm text-gray-400">
               You agree to our <p class="underline z-50">privacy policy.</p>
             </label>
           </div>
 ...
 <p class="mt-2 leading-loose text-gray-800 text-sm">
    Thank you for reaching out to CodeRed! We're excited to connect with you and explore how we can supercharge your digital transformation. 
    Our team will get back to you within 24 hours to discuss your goals and craft innovative solutions tailored to your needs. 
    At CodeRed, we don't just build—we revolutionize. Let's create something extraordinary together!
</p>
...
//  }
 ...
 const sendMessage = async () => {
   ...
   const payload = {
     service_id: 'service_bthzzm9',
     template_id: 'template_tlb3kkh',
     user_id: 'UmjmhrW7JhGgfzQUM',
     template_params: {
